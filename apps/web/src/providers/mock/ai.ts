...
// 로컬 개발용 Mock AI 비활성화(주석처리) — providers/index.ts에서 더 이상
// MockAiProvider를 쓰지 않는다. categoryLabel()만 실제 GeminiAiProvider가
// 가져다 쓰고 있어서 그대로 남겨뒀다.
//
// import { filterPlaces, koreaTimeParts } from '@oneulcourse/core';
// import type { PlaceCandidate, AggregatedPreference } from '@oneulcourse/core';
// import type {
//   AiProvider,
...
//   [
//     /산책|걷|공원|숲|수목원|한강|둘레길|산책로|호수공원|해변|바닷가|야경|전망대|등산|트레킹/,
//     'WALK',
//   ],
//
//   [
//     /전시|전시회|미술관|박물관|갤러리|미디어아트|아트센터|사진전|체험전|기획전|팝아트|전시관/,
//     'EXHIBITION',
//   ],
//
//   [
//     /쇼핑|편집샵|편집숍|팝업|팝업스토어|백화점|아울렛|쇼핑몰|몰링|소품샵|소품숍|빈티지샵|빈티지숍|플리마켓|시장|기념품샵|기념품숍|옷구경|구경/,
//     'SHOPPING',
//   ],
//
//   [
//     /스크린야구|야구|스크린골프|골프|볼링|당구|탁구|배드민턴|테니스|클라이밍|암벽등반|방탈출|보드게임|보드게임카페|pc방|피시방|오락실|게임센터|공방|원데이클래스|원데이 클래스|만들기|도자기|도예|향수만들기|향수 만들기|반지만들기|반지 만들기|가죽공예|목공|드로잉|그림그리기|쿠킹클래스|베이킹클래스|요리체험|체험|액티비티|놀이공원|테마파크|노래방|코인노래방|찜질방|사우나/,
//     'ACTIVITY',
//   ],
//
//   [
//     /술|술집|바|와인|와인바|맥주|수제맥주|펍|포차|포장마차|이자카야|칵테일|칵테일바|하이볼|호프|맥주집|소주|막걸리|전통주|위스키|위스키바|루프탑바/,
//     'BAR',
//   ],
//
//   [
//     /카페|커피|디저트|베이커리|빵집|빵|케이크|마카롱|쿠키|도넛|아이스크림|빙수|크로플|와플|브런치|티룸|차|애프터눈티|로스터리|커피숍|커피샵/,
//     'CAFE',
//   ],
// ];
//
